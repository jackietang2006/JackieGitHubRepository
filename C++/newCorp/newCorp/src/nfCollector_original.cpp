/* 
 * nfCollector.c - NF Collector utilizing UDP socket 
 * usage: nfCollector <port>
 */
...
int main(int argc, char **argv) {
  ...
  while (1) {
    ...
    /* 
     * print UDP datagram in binary format
    ...
    for(int i = 0; i < n; i++)
    {
      printf(BYTETOBINARYPATTERN, BYTETOBINARY(buf[i]));
    }
    printf("\n");
     */
